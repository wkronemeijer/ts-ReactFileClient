...
[common(tags("mid 2001"))]: {
    ...
    [common(tags("turagaMata"))]: listOf(
        {i:"8544-1",n:"Nuju"  ,t:tags("| 4 | maybeHaveParts |")},
        {i:"8540-1",n:"Vakama",t:tags("| 3 | maybeHaveParts |")},
        {i:"8543-1",n:"Nokama",t:tags("| 7 | want           |")},
        {i:"8541-1",n:"Matau" ,t:tags("| 4 |                |")},
        {i:"8542-1",n:"Onewa" ,t:tags("| 4 | maybeHaveParts |")},
    ...
    [common(tags("toaMata"))]: listOf(
        ...
        {i:"8533-1",n:"Gali"  ,t:tags("| 8 | i built it |")},
        {i:"8535-1",n:"Lewa"  ,t:tags("| 5 | i built it |")},
        {i:"8531-1",n:"Pohatu",t:tags("| 6 | like have  |")},
        {i:"8532-1",n:"Onua"  ,t:tags("| 6 | like have  |")},
    ), 
...
[common(tags("2002"))]: {
    [common(tags("bohrokVa"))]: listOf(
        {i:"8551-1",n:"Kohrak Va",t:tags("| 3 | ice   | i have it |")},
        {i:"8554-1",n:"Tahnok Va",t:tags("| 3 | fire  | i have it |")},
        {i:"8550-1",n:"Gahlok Va",t:tags("| 3 | water | i have it |")},
        {i:"8552-1",n:"Lehvak Va",t:tags("| 4 | air   |           |")},
        {i:"8553-1",n:"Pahrak Va",t:tags("| 3 | stone | i have it |")},
        {i:"8555-1",n:"Nuhvok Va",t:tags("| 2 | earth | i have it |")},
    ), 
    [common(tags("bohrok"))]: listOf(
        {i:"8565-1",n:"Kohrak",t:tags("| 5 | ice   | have |")},
        {i:"8563-1",n:"Tahnok",t:tags("| 6 | fire  |      |")},
        {i:"8562-1",n:"Gahlok",t:tags("| 4 | water | have |")},
...
[common(tags("2003"))]: {
    [common(tags("matoranNuva"))]: listOf(
        ...
        {i:"8583-1",n:"Hahli" ,t:tags("| 8 | ga | i want it |")},
        {i:"8586-1",n:"Macku" ,t:tags("| 7 | ga |           |")},
        {i:"8584-1",n:"Hewkii",t:tags("| 8 | po |           |")},
...
[common(tags("mid 2003"))]: {
    [common(tags("rahkshi"))]: listOf(
        ...
        {i:"8592-1",n:"Turahk" ,t:tags("| 5 | red   | maybeHaveParts |")},
        {i:"8590-1",n:"Guurahk",t:tags("| 6 | blue  | i like it      |")},
...
[common(tags("2004"))]:{
    [common(tags("matoranMetru"))]: listOf(
        {i:"8612-1",n:"Ehrye"  ,t:tags("| 4 | ko  | i built it |")},
        {i:"8607-1",n:"Nuhrii" ,t:tags("| 4 | ta  | i have it  |")},
        {i:"8608-1",n:"Vhisola",t:tags("| 4 | ga  | i have it  |")},
        {i:"8611-1",n:"Orkham" ,t:tags("| 3 | le  |            |")},
        {i:"8610-1",n:"Ahkmou" ,t:tags("| 4 | po  | i have it  |")},
        {i:"8609-1",n:"Tehutti",t:tags("| 3 | onu |            |")},
    ), 
    [common(tags("toaMetru | have"))]: listOf(
        {i:"8606-1",n:"Nuju"  ,t:tags("| 5 |      |")},
        {i:"8601-1",n:"Vakama",t:tags("| 7 |      |")},
        {i:"8602-1",n:"Nokama",t:tags("| 6 | like |")},
        {i:"8605-1",n:"Matau" ,t:tags("| 7 | like |")},
        {i:"8604-1",n:"Onewa" ,t:tags("| 5 |      |")},
        {i:"8603-1",n:"Whenua",t:tags("| 4 |      |")},
    ), 
},
...
[common(tags("2005"))]: {
    [common(tags("rahaga"))]: listOf(
        ...
        {i:"4877-1",n:"Norik  ",t:tags("| 2 | ta  |")},
        {i:"4868-1",n:"Gaaki  ",t:tags("| 2 | ga  |")},
    ...
    [common(tags("visorak"))]: listOf(
        ...
        {i:"8743-1",n:"Boggarak",t:tags("| 5 | blue  | maybeHaveParts |")},
...
[common(tags("mid 2005"))]: {
    ...
    [common(tags("toaHordika"))]: listOf(
        {i:"8741-1",n:"Nuju"  ,t:tags("| 6 | i like it       |")},
        {i:"8736-1",n:"Vakama",t:tags("| 5 |                 |")},
        {i:"8737-1",n:"Nokama",t:tags("| 7 | i reallyWant it |")},
        {i:"8740-1",n:"Matau" ,t:tags("| 7 |                 |")},
        {i:"8739-1",n:"Onewa" ,t:tags("| 6 | i want it       |")},
        {i:"8738-1",n:"Whenua",t:tags("| 4 | i built it      |")},
    ), 
    [common(tags("titan"))]: listOf(
        {i:"8755-1",n:"Keetongu",t:tags("| 3 | rahi           |                 |")},
        {i:"8756-1",n:"Sidorak" ,t:tags("| 6 | male steltian  |                 |")},
        {i:"8761-1",n:"Roodaka" ,t:tags("| 9 | female vortixx | i reallyWant it |")},
    ), 
...
[common(tags("2007"))]: {
    ...
    [common(tags("barraki"))]: listOf(
        {i:"8921-1",n:"Pridak" ,t:tags("| 6 | white | like |")},
        {i:"8917-1",n:"Kalmah" ,t:tags("| 6 | red   | like |")},
        {i:"8916-1",n:"Takadox",t:tags("| 7 | blue  | like |")},
        {i:"8920-1",n:"Ehlek"  ,t:tags("| 5 | green | like |")},
        {i:"8918-1",n:"Carapar",t:tags("| 7 | brown | like |")},
        {i:"8919-1",n:"Mantax" ,t:tags("| 6 | black | like |")},
    ), 
    [common(tags("|"))]: listOf(
...
[common(tags("| mid 2007 |"))]: {
    [common(tags("| toaMahri |"))]: listOf(
        ...
        {i:"8911-1",n:"Jaller",t:tags("| 8 | reallyWant | 2-in-1 | & rahi |")},
        {i:"8914-1",n:"Hahli" ,t:tags("| 8 | reallyWant |")},
        {i:"8910-1",n:"Kongu" ,t:tags("| 6 | have       |")},
        {i:"8912-1",n:"Hewkii",t:tags("| 7 | dislike    |")},
    ...
    [common(tags("|"))]: listOf(
        {i:"8940-1",n:"Karzahni & al.",t:tags(`| 9 | 4-in-1 | love want | \
            ...
            & stationary      \
        |`)},
        {i:"8939-1",n:"Lesovikk",t:tags("| 7 | 2-in-1 | toaCordak & large vehicle | like |")},
    ), 
},
...
[common(tags("2008"))]: {
    ...
    [common(tags("toaPhantoka"))]: listOf(
        {i:"8685-1",n:"Kopaka" ,t:tags("| 7 | white  |       |")},
    ...
    [common(tags("| makutaPhantoka |"))]: listOf(
        ...
        {i:"8692-1",n:"Vamprah",t:tags("| 8 | blue  | reallyWant |")}, 
...
[common(tags("2010 small"))]: listOf(
    {i:"7135-1",n:"Takanuva",t:tags("| 6 | toa            |       |")},
...
[common(tags("2015"))]: {
    [common(tags("protectorOf"))]: listOf(
        ...
        {i:"70782-1",n:"Izotor" ,t:tags("| 5 | of ice    |      |")},
        {i:"70783-1",n:"Narmoto",t:tags("| 5 | of fire   | like |")},
        {i:"70780-1",n:"Kivoda" ,t:tags("| 6 | of water  | like |")},
        {i:"70778-1",n:"Vizuna" ,t:tags("| 7 | of jungle | like |")},
        {i:"70779-1",n:"Nilkuu" ,t:tags("| 6 | of stone  |      |")},
        {i:"70781-1",n:"Korgot" ,t:tags("| 5 | of earth  |      |")},
    ), 
    [common(tags("masterOf"))]: listOf(
        {i:"70784-1",n:"Lewa"  , t:tags("| 5 | of jungle |      |")},
        {i:"70785-1",n:"Pohatu", t:tags("| 6 |           | like |")},
        {i:"70786-1",n:"Gali"  , t:tags("| 7 |           | love |")},
        {i:"70787-1",n:"Tahu"  , t:tags("| 5 |           | like |")},
        {i:"70788-1",n:"Kopaka", t:tags("| 6 |           |      |")},
        {i:"70789-1",n:"Onua"  , t:tags("| 4 |           |      |")},
    ), 
},

[common(tags("mid 2015"))]: {
    [common(tags("skullHunter"))]: listOf(
        {i:"70790-1",n:"Lord of Skull Spiders",t:tags("| 3 |")},
        {i:"70791-1",n:"Skull Warrior"        ,t:tags("| 4 |")},
        {i:"70792-1",n:"Skull Slicer"         ,t:tags("| 4 |")},
        {i:"70793-1",n:"Skull Basher"         ,t:tags("| 4 |")},
        {i:"70794-1",n:"Skull Scorpio"        ,t:tags("| 4 |")},
    ), 
    [common(tags("|"))]: listOf(
        {i:"70795-1",n:"Mask Maker vs. Skull Grinder",t:tags(`| 6 | 2-in-1 | \
            & large skullHunter \
            & Ekimu protectorOf \
        |`)},
    ), 
...
[common(tags("2016"))]: {
    [common(tags("creatureOf"))]: listOf(
        ...
        {i:"71300-1",n:"Uxar" ,t:tags("| 5 | of jungle |")},
        {i:"71301-1",n:"Ketar",t:tags("| 5 | of stone  |")},
        {i:"71304-1",n:"Terak",t:tags("| 5 | of earth  |")},
    ), 
    [common(tags("uniterOf"))]: listOf(
        {i:"71311-1",n:"Kopaka & Melum",t:tags("| 6 | 2-in-1 | & creatureOf ice |")},
        {i:"71308-1",n:"Tahu"          ,t:tags("| 7 |        |                  |")}, 
        {i:"71307-1",n:"Gali"          ,t:tags("| 6 |        |                  |")},
        {i:"71305-1",n:"Lewa"          ,t:tags("| 5 |        | of jungle        |")},
        {i:"71306-1",n:"Pohatu"        ,t:tags("| 4 |        |                  |")},
        {i:"71309-1",n:"Onua"          ,t:tags("| 7 |        |                  |")},
    ), 
    [common(tags("|"))]: listOf(
